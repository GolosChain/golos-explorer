...
getBlockchainVersion(nodeAddress, function(err, result) {
	if (result) {
		if (parseFloat(result.STEEMIT_BLOCKCHAIN_VERSION) < 0.18) golosJsVersion = '0.6.3';
		loadGolosJsLib();
	}
	else if (err) {
		loadGolosJsLib();
